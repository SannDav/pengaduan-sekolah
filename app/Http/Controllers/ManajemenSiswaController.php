...
class AdminApprovalController extends Controller
{
    public function index()
    {
        ...
        return view('admin_approval', compact('pending', 'approved', 'rejected', 'allSiswa', 'countPending'));
    }
    ...
    public function destroySiswa($nis)
    {
        ...
        return redirect()->back()->with('success', 'Akun siswa ' . $nama . ' (NIS: ' . $nis . ') berhasil dihapus!');
    }
}
